...
%Descripcion: Realizar 2 ejemplos de aplicación de los metodos de Runge-Kutta de orden 2 
...
try 
  ...
  [xv, yv, datos] = rksegundo (f,x0,x1,y0,h,1,sol);
  ...
  legend("Real", "Método")
  title('Problema de ejemplo - Heun - 0.5');
...
try 
  ...
  [xv, yv, datos] = rksegundo (f,x0,x1,y0,h,2,sol);
...
try 
  ...
  [xv, yv, datos] = rksegundo (f,x0,x1,y0,h,3,sol);
